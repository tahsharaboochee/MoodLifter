...
import {
  ...
  const PlayButtons = (props) => {
    const { playing, token, loading } = props.state;
        ...
        <div>
            <div className="pa3">
                ...
                <CardFooter>
                    ...
                    : 
                    (<button className=" no-underline f4 b bw2 ph3 pv2 mb2 dib white bg-transparent bg-animate hover-bg-black hover-white" onClick={() => props.onPlayClick()}
                    >
                    <Card>
                    <CardBody>
                    <CardImg
