    ...
    return (
        ...
        > 
          ...
          {loading ? (
                    ...
                    <Moods userName={userInfo.display_name} userId={userInfo.id} playlists={usersPlaylists} token={token} />
                )}
          </CardHeader>
          {
            playing || !loading ? 
            <div>
                ...
                <CardFooter>
                    <button className='f5 no-underline black bg-animate hover-bg-black hover-white inline-flex items-center pa3 ba border-box mr4 bg-transparent' 
                        onClick={() => props.onPrevClick()}> Previous </button>
                        <button className='f5 no-underline black bg-animate hover-bg-black hover-white inline-flex items-center pa3 ba border-box mr4 bg-transparent'
                        onClick={() => props.onPlayClick()}>{playing ? 
                            (  <Card>
                                <CardBody>
                                <CardImg
